class Slider{
    ...
    static init =()=>{
        this.#content = document.querySelector('.slider__list')
        this.#left = document.querySelector('.left_button')
        this.#right = document.querySelector('.right_button')
        this.max= this.#content.childElementsCount
